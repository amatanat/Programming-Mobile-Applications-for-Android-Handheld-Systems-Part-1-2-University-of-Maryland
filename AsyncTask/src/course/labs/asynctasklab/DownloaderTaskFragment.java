...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList arrayList = arguments.getStringArrayList(TAG_FRIEND_RES_IDS);
		
		Integer[] mResourceID = new Integer[arrayList.size()];
		
		mResourceID = (Integer[]) arrayList.toArray(mResourceID);
                
		// DONE: Start the DownloaderTask 
        downloadTask.execute(mResourceID);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Void, String[]>{
		...
		protected String[] doInBackground(Integer[]... param){
			Integer[] data = param[0];
			String[] sendResult = downloadTweets(data);
			return sendResult;
		}
